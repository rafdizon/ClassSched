...
class _AddInstructorDialogState extends State<AddInstructorDialog> {
  ...
  final _instructorNoController = TextEditingController();
              ...
              children: [
                    ...
                    TableRow(
                      children: [
                        ...
                        SizedBox(
                          height: 30,
                          child: TextField(
                            controller: _instructorNoController,
                ...
                Row(
                  ...
                  children: [
                    ...
                    TextButton(
                      onPressed: () async {
                        if(_dropdownValue != null && _selectedYear != null && _selectedStatus != null && _emailController.text != '' && _passwordController.text != '' && _instructorNoController.text != '' && _fnameController.text != '' && _lnameController.text != ''){
                          setState(() {
                            _isLoading = true;
                          });
                          final error = await AdminDBManager().registerInstructor(
                            ...
                            instructorNo: _instructorNoController.text,
